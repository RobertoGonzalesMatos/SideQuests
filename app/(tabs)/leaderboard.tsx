    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={[styles.button, pressed2 ? styles.buttonPressed : null]}
          ...
          .map((user, index) => {
            ...
            return (
              <View key={index} style={styles.leaderboardRow}>
                ...
                <Text style={[styles.leaderboardName, textColorStyle]}>{user.displayName}</Text>
                <Text style={[styles.leaderboardScore, textColorStyle]}>{user.score}</Text>
              </View>
            );
        })}
      </ScrollView>
