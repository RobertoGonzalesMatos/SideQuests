  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        {gemQuests.map((quest) => (
          <TouchableOpacity
            style={styles.gemQuestContainer}
            key={quest.id}
            onPress={() => {
              router.push({
                pathname: "/camera",
          ...
          >
            <View style={styles.rowContainer}>
              <ImageBackground
                ...
                style={styles.goldenTicketImageSmall}
                resizeMode="contain"
              >
                <Text style={styles.gemQuestText}>{quest.points}</Text>
              </ImageBackground>
              <Text style={styles.gemQuestDescriptionText}>
                {quest.description}
              </Text>
            </View>
          </TouchableOpacity>
